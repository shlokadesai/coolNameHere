...
write.csv(d1,paste("cpi2012.csv", sep=""),quote=FALSE, row.names=FALSE)
write.csv(d2,paste("cpi2013.csv", sep=""),quote=FALSE, row.names=FALSE)
write.csv(d3,paste("cpi2014.csv", sep=""),quote=FALSE, row.names=FALSE)